...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 回收员管理 <span class="c-gray en">&gt;</span> 待审核回收员<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
function member_stop(obj,id){
	layer.confirm('确认要通过审核吗？',function(index){
		var reuid = $(obj).parents("tr").find("#reuid").val();
		 
		$.post("changereuserstate.do",
		{reuid:reuid},
		function(result){
